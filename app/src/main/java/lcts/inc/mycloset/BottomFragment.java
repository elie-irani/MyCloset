...
public class BottomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) inflater.inflate(R.layout.fragment_bottom, container, false);
        ...
        try {
            ...
            Toast.makeText(getContext(), "Insert bottom!", Toast.LENGTH_SHORT).show();
        }
